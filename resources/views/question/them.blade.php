                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    ...
                    <form action="admin/question/add" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="content_question" placeholder="Please Enter Your Question"/>
                            <input type="button" name="" value="add" onclick="add()">
                        </div>
                        <div class="answer">
                        </div>
                        </form>
                        <button type="submit" class="btn btn-default" id="btSave"> Save </button>
